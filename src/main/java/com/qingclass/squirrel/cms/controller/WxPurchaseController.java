...
public class WxPurchaseController {
	...
	private final String TEMPLATE_TYPE = "purchase-notice-template";
	private final String CUSTOM_TYPE = "purchase-notice-custom";
	/**
	 *
	 * */
	@ResponseBody
	...
	public Map<String,Object> editTemplate(@RequestParam(value = "id",required = false)Integer id,@RequestParam(value = "contentHead",required = false)String contentHead,
	...
	public Map<String,Object> openOrCloseTemplate(@RequestParam(value = "id",required = false)Integer id,@RequestParam(value = "isOpen",required = false)Integer isOpen){
	...
	public Map<String,Object> previewTemplate(@RequestParam(value = "openId",required = false)String openId,
		...
		params.put("template_id",wxService.PURCHASE_NOTICE_TEMPLATE_ID);
		params.put("url",url);
